...
```tsx showLineNumbers title="pages/blog/[slug].tsx" {6-14}
...
````md showLineNumbers title="./content/posts/syntax-highlighting.mdx"
# Code Block
...
```diff showLineNumbers title="./contentlayer.config.js"
import { makeSource } from "contentlayer/source-files"
import rehypePrettyCode from "rehype-pretty-code"
import { Post } from "./content/definitions/Post"
