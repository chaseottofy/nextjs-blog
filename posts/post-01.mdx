...
>
  <Image
    className={'bannerImg'}
    src={'/images/posts/banners/post-01.webp'}
    alt={`Gradient Banner`}
    fill
    priority
  />
...
```html title="./html.html" showLineNumbers
<article class="prose">
...
```js title="./js.js" showLineNumbers
module.exports = {
  purge: [],
  theme: {
    extend: {},
...
| ----------------------- | ------------ | ------------------ |
| Bret "The Hitman" Hart yeah yeah yeahasdfasdfasdfaasdfasdfasdfasdfasdfasdfsdf | Calgary, AB  | Sharpshooter       |
